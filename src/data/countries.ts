...
export const countries: Country[] = [
  ...
  { name: "Bermuda", code: "BM", flag: "🇧🇲", phoneCode: "+1" },
  ...
  { name: "British Virgin Islands", code: "VG", flag: "🇻🇬", phoneCode: "+1" },
  ...
  { name: "Cayman Islands", code: "KY", flag: "🇰🇾", phoneCode: "+1" },
  ...
  { name: "Falkland Islands", code: "FK", flag: "🇫🇰", phoneCode: "+500" },
  { name: "Faroe Islands", code: "FO", flag: "🇫🇴", phoneCode: "+298" },
  { name: "Fiji", code: "FJ", flag: "🇫🇯", phoneCode: "+679" },
  { name: "Finland", code: "FI", flag: "🇫🇮", phoneCode: "+358" },
  { name: "France", code: "FR", flag: "🇫🇷", phoneCode: "+33" },
  { name: "French Guiana", code: "GF", flag: "🇬🇫", phoneCode: "+594" },
  { name: "French Polynesia", code: "PF", flag: "🇵🇫", phoneCode: "+689" },
  ...
  { name: "Gibraltar", code: "GI", flag: "🇬🇮", phoneCode: "+350" },
  { name: "Greece", code: "GR", flag: "🇬🇷", phoneCode: "+30" },
  { name: "Greenland", code: "GL", flag: "🇬🇱", phoneCode: "+299" },
  { name: "Grenada", code: "GD", flag: "🇬🇩", phoneCode: "+1" },
  { name: "Guadeloupe", code: "GP", flag: "🇬🇵", phoneCode: "+590" },
  { name: "Guam", code: "GU", flag: "🇬🇺", phoneCode: "+1" },
  { name: "Guatemala", code: "GT", flag: "🇬🇹", phoneCode: "+502" },
  { name: "Guernsey", code: "GG", flag: "🇬🇬", phoneCode: "+44" },
  ...
  { name: "Kosovo", code: "XK", flag: "🇽🇰", phoneCode: "+383" },
  ...
  { name: "Macau", code: "MO", flag: "🇲🇴", phoneCode: "+853" },
  ...
  { name: "Montserrat", code: "MS", flag: "🇲🇸", phoneCode: "+1" },
  ...
  { name: "New Caledonia", code: "NC", flag: "🇳🇨", phoneCode: "+687" },
  ...
  { name: "Niue", code: "NU", flag: "🇳🇺", phoneCode: "+683" },
  { name: "Norfolk Island", code: "NF", flag: "🇳🇫", phoneCode: "+672" },
  { name: "North Korea", code: "KP", flag: "🇰🇵", phoneCode: "+850" },
  { name: "North Macedonia", code: "MK", flag: "🇲🇰", phoneCode: "+389" },
  { name: "Northern Mariana Islands", code: "MP", flag: "🇲🇵", phoneCode: "+1" },
  ...
  { name: "Pitcairn Islands", code: "PN", flag: "🇵🇳", phoneCode: "+64" },
  { name: "Poland", code: "PL", flag: "🇵🇱", phoneCode: "+48" },
  { name: "Portugal", code: "PT", flag: "🇵🇹", phoneCode: "+351" },
  { name: "Puerto Rico", code: "PR", flag: "🇵🇷", phoneCode: "+1" },
  { name: "Qatar", code: "QA", flag: "🇶🇦", phoneCode: "+974" },
  { name: "Republic of the Congo", code: "CG", flag: "🇨🇬", phoneCode: "+242" },
  { name: "Réunion", code: "RE", flag: "🇷🇪", phoneCode: "+262" },
  { name: "Romania", code: "RO", flag: "🇷🇴", phoneCode: "+40" },
  { name: "Russia", code: "RU", flag: "🇷🇺", phoneCode: "+7" },
  { name: "Rwanda", code: "RW", flag: "🇷🇼", phoneCode: "+250" },
  { name: "Saint Barthélemy", code: "BL", flag: "🇧🇱", phoneCode: "+590" },
  { name: "Saint Helena", code: "SH", flag: "🇸🇭", phoneCode: "+290" },
  { name: "Saint Kitts and Nevis", code: "KN", flag: "🇰🇳", phoneCode: "+1" },
  { name: "Saint Lucia", code: "LC", flag: "🇱🇨", phoneCode: "+1" },
  { name: "Saint Martin", code: "MF", flag: "🇲🇫", phoneCode: "+590" },
  { name: "Saint Pierre and Miquelon", code: "PM", flag: "🇵🇲", phoneCode: "+508" },
  { name: "Saint Vincent and the Grenadines", code: "VC", flag: "🇻🇨", phoneCode: "+1" },
  ...
  { name: "Sint Maarten", code: "SX", flag: "🇸🇽", phoneCode: "+1" },
  ...
  { name: "Svalbard and Jan Mayen", code: "SJ", flag: "🇸🇯", phoneCode: "+47" },
  ...
  { name: "United States Virgin Islands", code: "VI", flag: "🇻🇮", phoneCode: "+1" },
  ...
  { name: "Wallis and Futuna", code: "WF", flag: "🇼🇫", phoneCode: "+681" },
  { name: "Western Sahara", code: "EH", flag: "🇪🇭", phoneCode: "+212" },
